...
<head runat="server">    <title>DIABITIC ASSISTANT</title>
    <meta charset="utf-8" />
...
<body>
    <form id="form1" runat="server">
      <audio id="myAudio1">
        ...
        <div class="row" style="background-image:url('4.jpg'); height:680px;background-attachment:fixed;background-size:cover;background-repeat:no-repeat;background-position:center center;">
            ...
            <div class="row" style="background-image:url('5.jpg');background-attachment:fixed;background-size:cover;background-repeat:no-repeat;background-position:center center;">
            <div class="col-sm-2"></div>
            <div class="col-sm-8">
                <div class="form-group">
                    <label style="font-size:28px;word-spacing:10px;color:red;text-shadow:1px 1px 1px white;">Enter Name--</label>
                    <input type="text" id="t1" class="form-control" />
                </div>
                <div class="form-group">
                    <label style="font-size:28px;word-spacing:10px;color:red;text-shadow:1px 1px 1px white;">Enter Height (in CM)--</label>
                    <input type="number" id="t2" class="form-control" />
                </div>
                <div class="form-group">
                    <label style="font-size:28px;word-spacing:10px;color:red;text-shadow:1px 1px 1px white;">Enter Weight (in KG)--</label>
                    <input type="number" id="t3" class="form-control" />
                </div>
                <div class="form-group">
                    <label style="font-size:28px;word-spacing:10px;color:red;text-shadow:1px 1px 1px white;"">Select Gender:
                ...
                <div class="form-group">
                    <label style="font-size:28px;word-spacing:10px;color:red;text-shadow:1px 1px white;">Enter Age (in Years)--</label>
                    <input type="number" id="t6" class="form-control" />
                </div>
                <!--<div class="form-group">
                <select style="font-size:28px;word-spacing:10px;color:red;text-shadow:1px 1px white;">Activity level
                    <option>Sedentary(no excercise)</option>
                    <option>Little(excercise/Sport 1-3 days/week)</option>
                    <option>Moderate(excercise/Sport 1-5 days/week)</option>
                    <option>Hard(excercise/Sport 1-7 days/week)</option>
                    <option>Very Hard(excercise/Sport 2 times/day)</option>
                    </select>    
                </div>-->
                <hr />
