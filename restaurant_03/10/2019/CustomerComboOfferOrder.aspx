<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="CustomerComboOfferOrder.aspx.cs" Inherits="CustomerComboOfferOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <table style="width: 100%; text-align: center;">
         ...
         <tr>
            <td><h1><strong><center><span style="text-decoration: underline; font-size: xx-large">
                <br />
                Add Customer Combo Offer Order !</span><br />
                <br />
                </center></strong></h1></td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <tr>
            <td><b>Menu Items.::*</b><center><asp:CheckBoxList ID="chkitem" runat="server" DataTextField="Menu" DataValueField="ComboId" AutoPostBack="true" RepeatLayout="OrderedList" Width="432px"></asp:CheckBoxList></center>
